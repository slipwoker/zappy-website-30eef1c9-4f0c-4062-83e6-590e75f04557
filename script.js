document.addEventListener('DOMContentLoaded', function () {
  ...
  function clearErrors(form) {
    ...
    invalidFields.forEach(function (field) { field.classList.remove('field-invalid'); });
  }
  ...
  function validateField(field) {
    ...
    if (field.hasAttribute('required') && value === '') {
      ...
      if (value.length < minLength) {
        errorMessage = field.dataset.errorMinlength || ('Please enter at least ' + minLength + ' characters.');
      }
    }
  ...
  if ('IntersectionObserver' in window) {
    ...
    const animatableElements = document.querySelectorAll(
      '.fade-in, .animate-on-scroll, [data-animate], .feature-card, .service-card, .testimonial-card, .pricing-card, .team-card, .blog-card, .gallery-item, .stat-item, .step-item'
    );
    ...
    if (!document.getElementById('scroll-animation-styles')) {
      ...
      style.textContent = [
        ...
        '}',
        '.fade-in-ready:nth-child(2) { transition-delay: 0.1s; }',
        '.fade-in-ready:nth-child(3) { transition-delay: 0.2s; }',
        '.fade-in-ready:nth-child(4) { transition-delay: 0.3s; }',
        '.fade-in-ready:nth-child(5) { transition-delay: 0.4s; }',
        '.fade-in-ready:nth-child(6) { transition-delay: 0.5s; }',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Hair ReNew Thailand משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '30eef1c9-4f0c-4062-83e6-590e75f04557',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '30eef1c9-4f0c-4062-83e6-590e75f04557';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '30eef1c9-4f0c-4062-83e6-590e75f04557';
